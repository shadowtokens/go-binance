...
```shell
go get github.com/shadowtokens/go-binance/v2
```
...
```golang
import (
    "github.com/shadowtokens/go-binance/v2"
)
```
...
```go
import (
    "github.com/shadowtokens/go-binance/v2/futures"
)
...
```go
import (
    "github.com/shadowtokens/go-binance/v2/delivery"
)
